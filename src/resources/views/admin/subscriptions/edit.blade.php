            ...
            <div class="mt-6 p-4 border border-gray-200 rounded-lg">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="space-x-2">
                        ...
                        <form action="{{ route('admin.subscriptions.generate-key', $user) }}" method="POST" class="inline">
                            @csrf
                            <button type="submit" 
                        ...
                        <form action="{{ route('admin.subscriptions.reset-usage', $user) }}" method="POST" class="inline">
                            @csrf
                            <button type="submit" 
